...
// * @author Итилей
// */
public class VxodKor extends javax.swing.JFrame {
...
public static VxodKorLent form2=new VxodKorLent();
public static VxodKor form3=new VxodKor();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Дата документа", "Номер входящего", "Наименование организации", "Номер регистрации", "Краткое содержание" }));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            ...
            while (rs.next()) pos++;
            rs.first();
            jTable1.setModel(new DefaultTableModel(pos, 5));
            jTable1.getColumnModel().getColumn(0).setHeaderValue("Дата сообщение"); // задаем название столбца 0
            jTable1.getColumnModel().getColumn(1).setHeaderValue("Номер входящего"); // задаем название столбца 1
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Имя организации");
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Номер регистрации");
            ...
            for (int i=0; i<pos; i++) {
                ...
                NUMBER=rs.getString("number");jTable1.setValueAt(NUMBER, i, 1);
                REGLOG=rs.getString("reg_log");jTable1.setValueAt(REGLOG, i, 3);
                NAMEORG=rs.getString("name_org");jTable1.setValueAt(NAMEORG, i, 2);
                MES=rs.getString("message");jTable1.setValueAt(MES, i, 4);
                rs.next();
            }
        } catch (SQLException ex) {
            Logger.getLogger(VxodKor.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   Desktop.getDesktop().open(f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VxodKor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
