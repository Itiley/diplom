...
// * @author Итилей
// */
public class SvedDvig extends javax.swing.JFrame {
static Connection con;
static Statement stmt;
static ResultSet rs, rs2;
int pos=100;
LocalDate today = LocalDate.now();
public static SvedDvig form1=new SvedDvig();
public static SvedDvigLent form2=new SvedDvigLent();
...
public static SvedDvig form12=new SvedDvig();
...
public static ZapPravo form14=new ZapPravo();
    ...
    try {
        ...
        Logger.getLogger(SvedDvig.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   Desktop.getDesktop().open(f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SvedDvig.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
