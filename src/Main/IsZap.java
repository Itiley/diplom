...
// * @author Итилей
// */
public class IsZap extends javax.swing.JFrame {
...
public static IsZapLent form2=new IsZapLent();
public static IsZap form3=new IsZap();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Дата документа", "Номер исходящего", "Наименование организации", "Краткое содержание", "Установленный срок по предоставлению информации", "Ответственное лицо", " " }));
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            ...
            jTable1.getColumnModel().getColumn(2).setHeaderValue("Имя организации"); // задаем название столбца 2
            jTable1.getColumnModel().getColumn(3).setHeaderValue("Краткое содержание");
            jTable1.getColumnModel().getColumn(4).setHeaderValue("Срок предоставления информации"); // задаем название столбца 2
            jTable1.getColumnModel().getColumn(5).setHeaderValue("Ответственный");
            for (int i=0; i<pos; i++) {
                DATA=rs.getString("date_created");jTable1.setValueAt(DATA, i, 0);
                REGLOG=rs.getString("reg_log");jTable1.setValueAt(REGLOG, i, 1);
                NAMEORG=rs.getString("name_org");jTable1.setValueAt(NAMEORG, i, 2);
                MES=rs.getString("message");jTable1.setValueAt(MES, i, 3);
                DATAEND=rs.getString("date_end");jTable1.setValueAt(DATAEND, i, 4);
                EMP=rs.getString("emp");jTable1.setValueAt(EMP, i, 5);
                rs.next();
            }
        } catch (SQLException ex) {
            Logger.getLogger(IsZap.class.getName()).log(Level.SEVERE, null, ex);
        }
 ...
 rs.first();
  ...
  File f=new File("E:/report1.pdf");
   Desktop.getDesktop().open(f);
    ...
    form6.setVisible(true);      // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
     form14.setVisible(true);    // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem5ActionPerformed

    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
     form13.setVisible(true) ;    // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem6ActionPerformed

    private void jMenuItem8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem8ActionPerformed
        form5.setVisible(true); // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem8ActionPerformed

    private void jMenuItem9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem9ActionPerformed
        form12.setVisible(true); // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem9ActionPerformed

    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
       form11.setVisible(true); // TODO add your handling code here:
    }//GEN-LAST:event_jMenuItem10ActionPerformed

    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        form9.setVisible(true);// TODO add your handling code here:
    ...
    private void jMenuItem15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem15ActionPerformed
        form10.setVisible(true);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsZap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
