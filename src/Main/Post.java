...
public static PostLent form2=new PostLent();
public static IsKor form3=new IsKor();
public static Post form4=new Post();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Номер", "Дата", "Наименование", "Краткое содержание", "Срок действия", "Дата вступления в силу", "Ответственный", "Наименованитае файла", "Ссылка на сайт", " ", " " }));
    ...
    try {
        String sql="SELECT * FROM \"public\".\"post\" LIMIT 100";
        ...
        jTable1.getColumnModel().getColumn(0).setHeaderValue("Номер"); // задаем название столбца 0
        jTable1.getColumnModel().getColumn(1).setHeaderValue("Дата"); // задаем название столбца 1
        jTable1.getColumnModel().getColumn(2).setHeaderValue("Наименование"); // задаем название столбца 2
        jTable1.getColumnModel().getColumn(3).setHeaderValue("Краткое содержание");
        jTable1.getColumnModel().getColumn(4).setHeaderValue("Срок действия"); 
        jTable1.getColumnModel().getColumn(5).setHeaderValue("Дата вступления в силу"); 
        jTable1.getColumnModel().getColumn(6).setHeaderValue("Ответственный"); 
        ...
        for (int i=0; i<pos; i++) {
          ...
          NAME=rs.getString("name");jTable1.setValueAt(NAME, i, 2);
          MES=rs.getString("message");jTable1.setValueAt(MES, i, 3);
          SROK=rs.getString("srok");jTable1.setValueAt(SROK, i,4);
          DATEPOST =rs.getString("date_resh");jTable1.setValueAt(DATEPOST, i, 5);
          EMP =rs.getString("employee");jTable1.setValueAt(EMP, i, 6);
