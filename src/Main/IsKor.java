...
// * @author Итилей
// */
public class IsKor extends javax.swing.JFrame {
...
public static IsKorLent form2=new IsKorLent();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try {
            ...
            while (rs.next()) pos++;
            rs.first();
            jTable1.setModel(new DefaultTableModel(pos, 4));
            ...
            Logger.getLogger(IsKor.class.getName()).log(Level.SEVERE, null, ex);
        }
...
form3.setVisible(true);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IsKor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
