...
// * @author Итилей
// */
public class SvedIno extends javax.swing.JFrame {
static Connection con;
static Statement stmt;
static ResultSet rs, rs2;
int pos=100;
LocalDate today = LocalDate.now();
public static SvedIno form1=new SvedIno();
public static SvedInoLent form2=new SvedInoLent();
...
public static SvedIno form7=new SvedIno();
...
public static SvedIno form12=new SvedIno();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Реестровый номер", "Наименование", "Адрес", "Балансовая стоимость", "Начисленная амортизация", "Дата возникновения/прекращения права муниципальной собственности", "Правообладатель", "Сведения об ограничениях", " ", " " }));
    ...
    try {
        ...
        jTable1.getColumnModel().getColumn(2).setHeaderValue("Балансовая стоимость"); 
        jTable1.getColumnModel().getColumn(3).setHeaderValue("Амортизация"); 
        jTable1.getColumnModel().getColumn(4).setHeaderValue("Дата приобретения/продажи собственности"); 
        jTable1.getColumnModel().getColumn(5).setHeaderValue("Реквизиты"); 
        jTable1.getColumnModel().getColumn(6).setHeaderValue("Правообладатель"); 
        jTable1.getColumnModel().getColumn(7).setHeaderValue("Сведения об ограничениях");
        for (int i=0; i<pos; i++) {
          REESTR=rs.getString("reestr");jTable1.setValueAt(REESTR, i, 0);
          NAME=rs.getString("name");jTable1.setValueAt(NAME, i, 1);
          
          BALANCE=rs.getString("balance");jTable1.setValueAt(BALANCE, i, 2);
          AMORT =rs.getString("amort");jTable1.setValueAt(AMORT, i, 3);
          
          DATA=rs.getString("date");jTable1.setValueAt(DATA, i, 4);
          REKVI=rs.getString("rekvi");jTable1.setValueAt(REKVI, i, 5);
          PRAVO=rs.getString("pravo");jTable1.setValueAt(PRAVO, i, 6);
          SVED=rs.getString("sved");jTable1.setValueAt(SVED, i, 7);
        ...
        Logger.getLogger(SvedIno.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   Desktop.getDesktop().open(f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SvedIno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
