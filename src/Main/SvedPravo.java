...
// * @author Итилей
// */
public class SvedPravo extends javax.swing.JFrame {
static Connection con;
static Statement stmt;
static ResultSet rs, rs2;
int pos=100;
LocalDate today = LocalDate.now();
public static SvedPravo form1=new SvedPravo();
public static SvedPravoLent form2=new SvedPravoLent();
...
public static SvedPravo form12=new SvedPravo();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Наименование", "Адрес", "ОГРН", "Дата регистрации", "Реквизиты", "Уставной фонд", "Данные о балансе", "Численность персонала", " ", " " }));
    ...
    try {
        ...
        jTable1.getColumnModel().getColumn(3).setHeaderValue("ОГРН");
        jTable1.getColumnModel().getColumn(4).setHeaderValue("Дата государственной регистрации"); 
        jTable1.getColumnModel().getColumn(5).setHeaderValue("Реквизиты"); 
        jTable1.getColumnModel().getColumn(6).setHeaderValue("Размер уставного фонда"); 
        jTable1.getColumnModel().getColumn(7).setHeaderValue("Данные о балансе");
        jTable1.getColumnModel().getColumn(8).setHeaderValue("Среднесписочная численность работников");
        for (int i=0; i<pos; i++) {
      
          NAME=rs.getString("name");jTable1.setValueAt(NAME, i, 1);
          ADRESS=rs.getString("adress");jTable1.setValueAt(ADRESS, i, 2);
          OGRN=rs.getString("ogrn");jTable1.setValueAt(OGRN, i,3);
          
          DATA=rs.getString("date");jTable1.setValueAt(DATA, i, 4);
          REKVI=rs.getString("rekvi");jTable1.setValueAt(REKVI, i, 5);
          FOND=rs.getString("fond");jTable1.setValueAt(FOND, i, 6);
          DANNUE=rs.getString("data");jTable1.setValueAt(DATA, i, 7);
          WORK=rs.getString("work");jTable1.setValueAt(WORK, i, 8);
        ...
        Logger.getLogger(SvedPravo.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   Desktop.getDesktop().open(f);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SvedPravo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
