...
import static Main.IsKor.form12;
...
// * @author Итилей
// */
public class Resh extends javax.swing.JFrame {
static Connection con;
static Statement stmt;
static ResultSet rs, rs2;
int pos=100;
LocalDate today = LocalDate.now();
public static ReshLent form2=new ReshLent();
...
public static ZapPravo form14=new ZapPravo();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Номер собрания", "Дата", "Номер", "Наименование", "Краткое содержание", "Дата вступления в силу", "Срок действия", "Наименование файла", "Ссылка на сайт", " ", " " }));
    ...
    try {
        ...
        while (rs.next()) pos++;
        rs.first();
        jTable1.setModel(new DefaultTableModel(pos, 9));
        jTable1.getColumnModel().getColumn(0).setHeaderValue("Номер собрания"); // задаем название столбца 0
        jTable1.getColumnModel().getColumn(1).setHeaderValue("Дата"); // задаем название столбца 1
        jTable1.getColumnModel().getColumn(2).setHeaderValue("Номер решения"); // задаем название столбца 2
        jTable1.getColumnModel().getColumn(3).setHeaderValue("Название");
        jTable1.getColumnModel().getColumn(4).setHeaderValue("Краткое содержание"); 
        jTable1.getColumnModel().getColumn(5).setHeaderValue("Дата вступления в силу"); 
        jTable1.getColumnModel().getColumn(6).setHeaderValue("Срок действия"); 
        jTable1.getColumnModel().getColumn(7).setHeaderValue("Наименование файла");
        jTable1.getColumnModel().getColumn(8).setHeaderValue("Ссылка на сайт");
        for (int i=0; i<pos; i++) {
          NUMBER=rs.getString("number");;jTable1.setValueAt(NUMBER, i, 0);
          DATA=rs.getString("date");jTable1.setValueAt(DATA, i, 1);
          NUMBERRESH=rs.getString("number_resh");;jTable1.setValueAt(NUMBERRESH, i, 2);
          NAME=rs.getString("name");jTable1.setValueAt(NAME, i, 3);
          MES=rs.getString("message");jTable1.setValueAt(MES, i,4);
          DATERESH =rs.getString("date_resh");jTable1.setValueAt(DATERESH, i, 5);
          SROK=rs.getString("srok");jTable1.setValueAt(SROK, i, 6);
          FILE=rs.getString("file");jTable1.setValueAt(FILE, i, 7);
          SSULKA=rs.getString("ssulka");jTable1.setValueAt(SSULKA, i, 8);
        ...
        Logger.getLogger(Resh.class.getName()).log(Level.SEVERE, null, ex);
    }
   ...
   Desktop.getDesktop().open(f);
    ...
    if(returnVal == JFileChooser.APPROVE_OPTION) {
       System.out.println("You chose to open this file: " +
        ...
        newsheet = new File(chooser.getSelectedFile().getPath() + "\\Resh.xls");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Resh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
